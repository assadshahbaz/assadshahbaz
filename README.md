...
I build web applications that are meant to last. Scalable architecture, clean code, and third-party integrations done properly. Based in Glasgow, UK. Working with teams globally since 2018.
...
Web-based ticketing app built with Angular 19, Node.js, MongoDB, and Elasticsearch. Fully containerised with Docker Compose. Includes Swagger API documentation and server-side rendering.
